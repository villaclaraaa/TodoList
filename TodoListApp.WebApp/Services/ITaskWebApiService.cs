...
public interface ITaskWebApiService
{
    ...
    Task<IEnumerable<TodoTask>> AssignedTasks(Guid userId, int page = 1, int pageSize = 10,
    ...
    Task<int> GetAssignedTasksCountAsync(Guid userId, Models.TaskStatus? statusFilter = null, string? tagFilter = null);
}
